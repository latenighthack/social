...
import com.latenighthack.social.login.domain.LoginClientImpl
import com.latenighthack.social.login.service.ChallengeStore
import com.latenighthack.social.login.service.ConsoleEmailSender
import com.latenighthack.social.login.service.ConsoleSmsSender
import com.latenighthack.social.login.service.CredentialStore
import com.latenighthack.social.login.service.CustodyCrypto
import com.latenighthack.social.login.service.DevSocialTokenVerifier
import com.latenighthack.social.login.service.LoginServiceImpl
import com.latenighthack.social.login.service.Pbkdf2Hasher
...
// Boots the full lockers monolith (for account create/restore) and the login gRPC service on one
// in-process server, so a single rpcClient drives both.
