 ...
 */
internal suspend fun AuthenticateResponse.toSignInResult(account: AccountManager): SignInResult =
    when (result) {
...
internal fun LoginResult.toChallengeResult(): ChallengeResult =
    if (this == LoginResult.LOGIN_RESULT_OK) ChallengeResult.Started else ChallengeResult.Failed("could not start the challenge")
